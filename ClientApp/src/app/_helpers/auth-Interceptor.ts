...
export class AuthInterceptor implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    // if (req.params.get('Client') === 'true') {
    //   req.params['map'].delete('Client');
    //   req = this.addAuthenticationTokenClient(req);
    // }
  ...
  // private addAuthenticationTokenClient(request: HttpRequest<any>): HttpRequest<any> {
  //   const currentUser = this.authenticationService.getUserClient();
  //   if (currentUser) {
  //       this.token = currentUser.token;
  //   }
  //   if (!this.token) {
